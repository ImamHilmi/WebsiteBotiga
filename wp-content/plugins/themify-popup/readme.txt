...
= 1.2.7 (2021.02.12) =
* Fix: Display limit gets reset if you close the browser and open the site again
* Fix: Page Viewed option switches to the time delay after saving

= 1.2.6 (2021.01.13) =
* Fix: Page Viewed option switches to the time delay after saving
* Removed: Post option tab on Popup custom panel

= 1.2.5 (2020.12.03) =
* Fix: xss attack prevention in metabox

= 1.2.4 (2020.11.25) =
* Fix: popup, fix two popups showing at the same time, also fix page view count
