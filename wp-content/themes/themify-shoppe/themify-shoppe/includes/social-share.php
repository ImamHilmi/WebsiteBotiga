...
<div class="share-wrap">
	<a class="share-button" href="javascript:void(0);"><?php echo themify_get_icon('export','ti',true)?><span class="screen-reader-text"><?php _e( 'Share', 'themify' ); ?></span></a>
	<div class="social-share">
		<?php foreach($networks as $k=>$n):?>
			...
			echo themify_get_icon($k,'ti',true)?>
		    </a>
		<?php endforeach;?>
	</div>
</div>
