...
$woo_invoice_comparetable                = array(
    ...
    array(
        'title' => __('Order Shipping Label Print', 'webappick-pdf-invoice-for-woocommerce'),
        'free'  => false,
    ),
    array(
        'title' => __('Download Bulk Shipping Label Print', 'webappick-pdf-invoice-for-woocommerce'),
        'free'  => false,
    ),
    array(
    ...
    <div class="woo-invoice-section woo-invoice-woo-invoice-banner">
        <div class="woo-invoice-banner">
            <a href="https://webappick.com/plugin/woocommerce-pdf-invoice-packing-slips/?utm_source=customer_site&utm_medium=free_vs_pro&utm_campaign=woo_invoice_free" target="_blank">
                <img class="woo-invoice-banner__graphics" src="<?php echo esc_url(WOO_INVOICE_FREE_PLUGIN_URL); ?>admin/images/chalan-pro-banner.svg" alt="<?php esc_attr_e('Upgrade to Wooinvoice Pro to unlock more powerful features.', 'webappick-pdf-invoice-for-woocommerce'); ?>">
            </a>
        </div>
    </div>
    <div class="clear"></div>
        ...
        <div class="comparison-table">
            <div class="comparison free">
                <div class="product-header">
                    <img src="<?php echo esc_url(WOO_INVOICE_FREE_PLUGIN_URL); ?>admin/images/chalan-lite.svg" alt="<?php esc_attr_e('Woowoo-invoice Lite', 'webappick-pdf-invoice-for-woocommerce'); ?>">
                </div>
            ...
            <div class="comparison pro">
                <div class="product-header">
                    <img src="<?php echo esc_url(WOO_INVOICE_FREE_PLUGIN_URL); ?>admin/images/chalan-pro.svg" alt="<?php esc_attr_e('Woowoo-invoice Pro', 'webappick-pdf-invoice-for-woocommerce'); ?>">
                </div>
                <ul class="product-features">
    ...
    <div class="woo-invoice-section woo-invoice-payment">
        <div class="payment-guarantee">
            <div class="guarantee-seal">
                <img src="<?php echo esc_url(WOO_INVOICE_FREE_PLUGIN_URL); ?>admin/images/14-days-money-back-guarantee.svg" alt="<?php esc_html_e('14 Days Money Back Guarantee', 'webappick-pdf-invoice-for-woocommerce'); ?>">
            </div>
