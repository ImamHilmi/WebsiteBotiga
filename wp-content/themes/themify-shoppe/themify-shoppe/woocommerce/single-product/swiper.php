...
<div class="swiper-container tf_carousel product-images-carousel tf_overflow tf_rel tf_right tf_w tf_opacity">
	<div class="swiper-wrapper tf_rel tf_w tf_h">
		<?php foreach ( $attachment_ids as $attach ):?>
			...
			?>
			<div <?php if($hasZoom===true ):?>data-zoom-image="<?php echo $props['url']?>" <?php endif;?> class="swiper-slide woocommerce-main-image woocommerce-product-gallery__image post-image<?php if($hasZoom===true ):?> zoom<?php endif;?>">
				<?php echo $image;?>
			</div>
		<?php endforeach;?>
	</div>
