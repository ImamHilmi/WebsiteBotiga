...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'accent_background_hover_color' => array(
			...
			'selector' => 'input[type=reset]:hover, input[type=submit]:hover, button:hover, .icon-menu .icon-menu-count:hover, #headerwrap #cart-icon:hover, #main-nav .has-mega-column .product-categories li:hover > .count, .woocommerce ul.products li.product .button:hover, .woocommerce #respond input#submit:hover, .woocommerce #respond input#submit.alt:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover, .woocommerce button.button.alt.disabled:hover, .woocommerce button.button:disabled:hover, .woocommerce button.button:disabled[disabled]:hover, .wishlist-button.wishlisted:hover, .woocommerce ul.products li.product a.wishlisted:hover, #cart-wrap .button:hover',
			'prop' => 'background',
		),
