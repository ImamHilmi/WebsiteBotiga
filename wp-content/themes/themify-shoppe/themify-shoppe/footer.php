...
if(themify_theme_show_area( 'footer_back' )){
	...
	if($is_float || (!$is_float && $footer_enable)){
		...
		$backTop=sprintf( '<div class="back-top tf_vmiddle tf_inline_b tf_textc clearfix %s"><div class="arrow-up"><a aria-label="%s" rel="nofollow" href="#header"><span class="screen-reader-text">%s</span></a></div></div>'
...
<?php if ( $footer_enable) : ?>
    ...
    <div id="footerwrap" class="tf_clear tf_box">
	    ...
	    <footer id="footer" class="pagewidth tf_box clearfix<?php if($header_design==='header-bottom'):?> tf_scrollbar<?php endif;?>" itemscope="itemscope" itemtype="https://schema.org/WPFooter">
