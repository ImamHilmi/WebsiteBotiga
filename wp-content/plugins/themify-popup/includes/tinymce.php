...
class Themify_Popup_TinyMCE {
	...
	static function init() {
		...
		add_action( 'wp_enqueue_scripts', array( __CLASS__, 'tinymce_localize' ) );
		add_action( 'admin_enqueue_scripts', array( __CLASS__, 'tinymce_localize' ) );
	}
	...
	static function get_manual_popup_list() {
		$list = array();
		$args = array(
	...
	static function tinymce_localize() {
		$fields = array(
