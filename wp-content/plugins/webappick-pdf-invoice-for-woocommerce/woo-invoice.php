 ...
 *
 * @package  Woo_Invoice
 * Plugin Name:  Chalan - PDF Invoice & Packing Slip for WooCommerce
...
define( 'WOO_INVOICE_FREE_VERSION', '3.1.18' );
...
function woo_invoice_review_notice() {
	...
	$notice .= '</div>';
	$notice .= '</div>';
	if ( ! $options && time() >= get_option( 'woo-invoice-activation-time' ) + ( 7 * 24 * 60 * 60 ) ) {
...
/**
 * improve review request functionality.
 */
