...
class Insights {
	...
	public function deactivate_scripts() {
		...
		?>
		<div class="wapk-dr-modal" id="<?php echo $this->client->getSlug(); ?>-wapk-dr-modal" aria-label="<?php printf( esc_attr__( '&ldquo;%s&rdquo; Uninstall Confirmation', 'webappick-pdf-invoice-for-woocommerce' ), $this->client->getName() ); ?>" role="dialog" aria-modal="true">
